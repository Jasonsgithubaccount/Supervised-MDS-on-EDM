function [sol, model, Out_te_boot]= Bootstrap632_SMDS_1vsall(  B, data, target, dim, alpha, q, disttype,  varargin )
% - estimate SMDS error rate using bootstrap .632+ rule
%
% USAGE: [sol, model, Out_te_boot]= Bootstrap632_SMDS(  B, data, target, dim, alpha, q, disttype,  varargin )
%
